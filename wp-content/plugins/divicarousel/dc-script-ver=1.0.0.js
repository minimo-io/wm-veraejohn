...
jQuery(function(jQuery) {
  ...
  if(jQuery(".df-area").length > 1) {
    ...
    jQuery(".dc-carousel").each(function(moduleIndex, filterElement){

      // initialize carousel
      $(this).flickity({

        // autoplay speed  in ms, set it to false to stop the autoplay feature
        autoPlay: 4000,
        // autoPlay: false,
    
        // adjust height of each slide
        ...
        // how many cells should move at 1 drag
        groupCells: 1,
